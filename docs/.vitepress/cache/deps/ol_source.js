...
import "./chunk-VM3VPHRP.js";
import {
  DEFAULT_MAX_ZOOM,
  DEFAULT_TILE_SIZE
} from "./chunk-PC3WH4C4.js";
...
addDecoder([void 0, 1], () => import("./raw-R7NPEAUI.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-JV75DLLS.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-PGYODFKQ.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-STQ3NVTD.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-IRZJ6O63.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-G7U53O2E.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(50001, () => import("./webimage-74B3PYTE.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-7G6OEI5M.js").then((module) => {
...
var ImageArcGISRest = class extends Image_default {
  /**
...
var ImageMapGuide = class extends Image_default {
  /**

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/SvgLayer.CHqt2PAL.js","assets/chunks/Map.CMggeVBg.js","assets/chunks/framework.sL2pcHsl.js"])))=>i.map(i=>d[i]);
import{v as c,V as d,E as g,C as u,c as v,o as p,j as n,ah as h,G as t,a as r,ai as f,p as w,k as a,w as l,aj as y}from"./chunks/framework.sL2pcHsl.js";import{I as x,$ as E}from"./chunks/index.xlq-uQqE.js";const C=`<template>\r
    <div id="map"></div>\r
</template>\r
\r
...
</style>`,M=JSON.parse('{"title":"SVG 图层","description":"","frontmatter":{},"headers":[],"relativePath":"map/svgLayer.md","filePath":"map/svgLayer.md"}'),_={name:"map/svgLayer.md"},j=Object.assign(_,{setup(L){const o=w(!0),s=g();return c(async()=>{s.value=(await d(async()=>{const{default:i}=await import("./chunks/SvgLayer.CHqt2PAL.js");return{default:i}},__vite__mapDeps([0,1,2]))).default}),(i,e)=>{const m=u("ClientOnly");return p(),v("div",null,[e[1]||(e[1]=n("h1",{id:"svg-图层",tabindex:"-1"},[r("SVG 图层 "),n("a",{class:"header-anchor",href:"#svg-图层","aria-label":'Permalink to "SVG 图层"'},"​")],-1)),e[2]||(e[2]=n("p",null,[r("利用 "),n("strong",null,"Layer"),r(" 的 "),n("strong",null,"render"),r(" 函数渲染")],-1)),h(t(a(x),null,null,512),[[f,o.value]]),t(m,null,{default:l(()=>[t(a(E),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{o.value=!1}),vueCode:a(C)},y({_:2},[s.value?{name:"vue",fn:l(()=>[t(a(s))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{M as __pageData,j as default};

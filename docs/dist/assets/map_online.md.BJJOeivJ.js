const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Online.gsTpGY4K.js","assets/chunks/TileImage.D5I42GMs.js","assets/chunks/UrlTile.BH1UFsTT.js","assets/chunks/Map.BwrX5Jh7.js","assets/chunks/common.DJhZ-xgw.js","assets/chunks/index.CUHFPbr6.js","assets/chunks/framework.dxdiOovJ.js","assets/chunks/XYZ.BlYmQVy0.js"])))=>i.map(i=>d[i]);
import{v as s,V as p,C as c,o as m,c as d,ag as u,ah as T,ai as E,E as e,k as t,w as l,aj as y,G as f,p as h}from"./chunks/framework.dxdiOovJ.js";import{I as L,$ as R}from"./chunks/index.B6hEiStf.js";const g="/assets/image.CmBzrGAS.png",v="/assets/image-1.CDwrmFWL.png",_=`<template>\r
    <div id="map"></div>\r
...
</style>`,b=JSON.parse('{"title":"在线地图","description":"","frontmatter":{},"headers":[],"relativePath":"map/online.md","filePath":"map/online.md"}'),S={name:"map/online.md"},x=Object.assign(S,{setup(M){const a=h(!0),n=f();return s(async()=>{n.value=(await p(async()=>{const{default:o}=await import("./chunks/Online.gsTpGY4K.js");return{default:o}},__vite__mapDeps([0,1,2,3,4,5,6,7]))).default}),(o,r)=>{const i=c("ClientOnly");return m(),d("div",null,[r[1]||(r[1]=u('<h1 id="在线地图" tabindex="-1">在线地图 <a class="header-anchor" href="#在线地图" aria-label="Permalink to &quot;在线地图&quot;">​</a></h1><p>该篇主要介绍 ol 怎么加载常用的天地图、高德地图、百度地图等。<br> 天地图要先到<a href="http://lbs.tianditu.gov.cn/server/MapService.html" target="_blank" rel="noreferrer">官网</a>申请Key，赋值给url中的tk。<br> Google Map中国、高德和腾讯都采用的火星坐标系，百度地图在火星坐标系的基础上进行了二次加密。 若系统接入的其他地理数据是和底图一样的坐标系，则不需要对底图做其他操作； 若系统接入的地理数据是真实坐标，则需要对底图进行纠偏处理。<br> Openlayers 中默认支持的坐标系为EPSG:4326和EPSG:3857，除此外的坐标需自定义，可以先到<a href="https://epsg.io/" target="_blank" rel="noreferrer">EPSG 官网</a>获取对应坐标系的元数据，对于EPSG官网上定义的坐标系，可以通过<a href="https://www.npmjs.com/package/proj4" target="_blank" rel="noreferrer">proj4</a>库注册使用。可以参考<a href="https://openlayers.org/en/latest/examples/reprojection.html" target="_blank" rel="noreferrer">官方示例1</a>、<a href="https://openlayers.org/en/latest/examples/reprojection-image.html" target="_blank" rel="noreferrer">官方示例2</a>。<br> 对于火星坐标系和百度坐标系，可以使用<a href="https://www.npmjs.com/package/projzh?activeTab=readme" target="_blank" rel="noreferrer">projzh</a> 。<br><img src="'+g+'" alt="alt text"><img src="'+v+'" alt="alt text"></p>',2)),T(e(t(L),null,null,512),[[E,a.value]]),e(i,null,{default:l(()=>[e(t(R),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:r[0]||(r[0]=()=>{a.value=!1}),vueCode:t(_)},y({_:2},[n.value?{name:"vue",fn:l(()=>[e(t(n))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{b as __pageData,x as default};

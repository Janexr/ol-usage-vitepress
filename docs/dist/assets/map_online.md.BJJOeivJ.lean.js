...
</style>`,b=JSON.parse('{"title":"在线地图","description":"","frontmatter":{},"headers":[],"relativePath":"map/online.md","filePath":"map/online.md"}'),S={name:"map/online.md"},x=Object.assign(S,{setup(M){const a=h(!0),n=f();return s(async()=>{n.value=(await p(async()=>{const{default:o}=await import("./chunks/Online.gsTpGY4K.js");return{default:o}},__vite__mapDeps([0,1,2,3,4,5,6,7]))).default}),(o,r)=>{const i=c("ClientOnly");return m(),d("div",null,[r[1]||(r[1]=u("",2)),T(e(t(L),null,null,512),[[E,a.value]]),e(i,null,{default:l(()=>[e(t(R),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:r[0]||(r[0]=()=>{a.value=!1}),vueCode:t(_)},y({_:2},[n.value?{name:"vue",fn:l(()=>[e(t(n))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{b as __pageData,x as default};
